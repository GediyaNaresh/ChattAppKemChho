...
import com.nareshgediya.kemchho.databinding.ItemReceiveGroupBinding;
import com.nareshgediya.kemchho.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == ITEM_SENT) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_receive_group
                    , parent, false);
